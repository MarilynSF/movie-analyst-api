...
var connection = mysql.createConnection({
  host     : process.env.DB_HOST || 'db-rampup.ckj6woduofyq.us-east-1.rds.amazonaws.com:3306',
  user     : process.env.DB_USER || 'juanforo',
  password : process.env.DB_PASS || 'juanforo',
